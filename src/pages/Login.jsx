    ...
    try {
      ...
      if (response && response.success) {
        ...
        setTimeout(() => {
          ...
          if (user.isFirstLogin && (user.role === 'faculty' || user.role === 'admin')) {
            console.log('Login: Redirecting faculty/admin to change password');
            navigate('/change-password');
          } else {
            console.log('Login: Redirecting based on role:', user.role);
            switch (user.role) {
              case 'student':
